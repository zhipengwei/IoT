...
#define EXPERIMENT_SENDER_DOWNTIME_MEAN 2
#define EXPERIMENT_SENDER_DOWNTIME_BOUND 2

#define EXPERIMENT_SENDER_PACKET_SIZE 1040
#define EXPERIMENT_SENDER_PACKETS_PER_SHORT_FLOW 10

// sender link, data rate is bps; delay is in mili seconds;
#define EXPERIMENT_CONFIG_SENDER_LINK_DATA_RATE 2000000
#define EXPERIMENT_CONFIG_SENDER_LINK_DATA_RATE_STRING "2000000b/s"
#define EXPERIMENT_CONFIG_SENDER_LINK_DELAY 20000

// server link
#define EXPERIMENT_CONFIG_SERVER_LINK_DATA_RATE 20000000
#define EXPERIMENT_CONFIG_SERVER_LINK_DELAY 200000
